...
namespace WinterBackgroundsPixelArt2
{
    ...
    public class ParallaxEffectEditor : Editor
    {
        public override void OnInspectorGUI()
        {
            ...
            parallaxEffect.independentSpeed =
                EditorGUILayout.Slider(new GUIContent("Independant Speed", "The layer will move independently to the left if the value is less than 0, and to the right if the value is greater than 0."), parallaxEffect.independentSpeed, -1.0f, 1.0f);
